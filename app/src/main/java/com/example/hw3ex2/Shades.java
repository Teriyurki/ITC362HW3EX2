...
//Here is where we will write our functionality to use in our controller.
public class Shades {
    public static final int SIDEh = 3;
    public static final int SIDEw = 1;
    private int [][] color;

    public Shades(){
        color = new int[SIDEw][SIDEh];
    }

   // public int showMessage (int row, int col) {
